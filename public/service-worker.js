self.addEventListener('install', (event) => {
  event.waitUntil(caches.open('srk-portal-shell-v6').then((cache) => cache.addAll([
    ...
    '/images/pitis-icon-192.png',
    '/images/pitis-icon-512.png',
    '/css/theme-c.css',
    '/css/styles.css',
