...
router.get("/dashboard", async (req, res) => {
  ...
  res.render("admin-dashboard", {
    ...
    backupLatestSaved: backupDashboard.latestSaved,
    backupStorage: backupDashboard.storage,
    backupRetentionCount: backupDashboard.retentionCount,
    backupRecoveryTestIntervalDays: backupDashboard.recoveryTestIntervalDays,
