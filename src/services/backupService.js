...
const BACKUP_TABLES = {
  ...
  point_logs: ["id", "student_id", "class_id", "points", "reason", "awarded_by", "awarded_at", "award_mode", "award_week_start", "award_day"],
  ...
  try {
    ...
    fs.writeFileSync(
      ...
      [
        ...
        "",
        "The ZIP contains the database snapshot and managed public uploads."
      ].join("\r\n"),
      "utf8"
    );
