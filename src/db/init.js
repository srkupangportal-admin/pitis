...
function mapLegacyStudentRow(row) {
  ...
  return {
    ...
    photo_2_path: normalizeOptionalText(row.photo_2_path),
    photo_2_uploaded_at: normalizeOptionalText(row.photo_2_uploaded_at),
    photo_2_uploaded_by: row.photo_2_uploaded_by || null,
    photo_3_path: normalizeOptionalText(row.photo_3_path),
    photo_3_uploaded_at: normalizeOptionalText(row.photo_3_uploaded_at),
    photo_3_uploaded_by: row.photo_3_uploaded_by || null,
    photo_4_path: normalizeOptionalText(row.photo_4_path),
    photo_4_uploaded_at: normalizeOptionalText(row.photo_4_uploaded_at),
    photo_4_uploaded_by: row.photo_4_uploaded_by || null,
    photo_5_path: normalizeOptionalText(row.photo_5_path),
    photo_5_uploaded_at: normalizeOptionalText(row.photo_5_uploaded_at),
    photo_5_uploaded_by: row.photo_5_uploaded_by || null,
    photo_6_path: normalizeOptionalText(row.photo_6_path),
    photo_6_uploaded_at: normalizeOptionalText(row.photo_6_uploaded_at),
    photo_6_uploaded_by: row.photo_6_uploaded_by || null,
